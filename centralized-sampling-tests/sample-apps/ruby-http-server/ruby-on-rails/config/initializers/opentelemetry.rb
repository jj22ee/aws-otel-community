...
OpenTelemetry.tracer_provider.sampler = OpenTelemetry::Sampler::XRay::InternalAwsXRayRemoteSampler.new(polling_interval:10, resource:OpenTelemetry::SDK::Resources::Resource.create({
  "service.name"=>"adot-integ-test",
