...
# from sdfsdf.opentelemetry.distro.sampler.aws_xray_remote_sampler import \
...
xraySampler = AwsXRayRemoteSampler(resource=resource, polling_interval=10)
print(xraySampler.get_description())
